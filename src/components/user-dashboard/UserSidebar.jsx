...
//   // Auto-open AI Tools submenu if on an AI Tools page
//   useEffect(() => {
//     if (pathname?.startsWith('/user/ai-tools')) {
//       setAiToolsOpen(true);
//     }
//   }, [pathname]);
...
//             </div>
//             <div className={`transition-transform duration-200 ${aiToolsOpen ? 'rotate-0' : 'rotate-0'}`}>
...
//   return (
//     <aside className="fixed left-0 top-0 flex h-screen w-64 flex-col bg-[#1a0a4b] text-white shadow-xl">
//       {/* Logo Section */}
//       <div
//         role="button"
//         tabIndex={0}
...
//         <div className="mb-6">
//           <p className="mb-3 px-4 text-[11px] font-semibold tracking-widest text-gray-400 uppercase">
//             Menu
//           </p>
...
//       <div className="border-t border-white/5 bg-[#14083a] p-4">
//         <p className="mb-4 px-2 text-[11px] font-semibold tracking-widest text-gray-400 uppercase">
//           Profile
//         </p>
        
//         <div className="mb-6 flex items-center gap-3 px-2">
//           <div className="h-10 w-10 overflow-hidden rounded-full border border-purple-400/30 shrink-0">
//             {/* TODO: Replace with AuthContext dynamic user data */}
//             <img 
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-white/5 bg-[#14083a] p-4 flex-shrink-0">
        ...
        <div className="mb-4 flex items-center gap-3 px-2">
          <div className="h-10 w-10 overflow-hidden rounded-full border border-purple-400/30 shrink-0">
            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Jenny" alt="Avatar" className="h-full w-full object-cover" />
          </div>
          <div className="flex flex-col min-w-0">
            <span className="text-sm font-bold text-white truncate">Jenny Wilson</span>
            <span className="text-[11px] text-gray-400 truncate">jen.wilson@example.c...</span>
